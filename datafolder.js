...
function getEncryptedObject(userName,userAddress,userNumber,userEmail){

var arr ;

var type = "dataStorage";
var userArray = [userName,userAddress,userNumber,userEmail];
var userFields =['userName','userAddress','userNumber','userEmail'];
...
arr = getDataInEncryptedForm(userArray, userFields);
...
return arr;
 ...
 function addData(userdataObject){

var db =  getDatabaseObject();

var db_name = 'dataStorage';

var key = userdataObject.userName;
console.log(key)
  
   db.put(db_name,userdataObject,key).done(function(x) {
 ...
 function getDataInEncryptedForm(objectData,objectField){
 
 var items = 0;
 var userDataObject = {};
 var userEncryptionKey = "remoteStorage";
 
 
var db =  getDatabaseObject();

  for(items = 0; items < objectField.length; items++){
    
                 
                 
                 if(objectData[items]){
  
                     userDataObject[objectField[items]] = encryptData(objectData[items],userEncryptionKey);
                 }
...
var db =  getDatabaseObject();
 ...
 db.executeSql('SELECT * FROM  dataStorage').then (function(results) {
   
   
 userEncryptionKey =  "remoteStorage" ;
...
var db =  getDatabaseObject();
         ...
         for(var items = 0; items < userArray.length ; items++){
                       ...
                       //   console.log( userDecryptedData[userArray[items]] + "" +items);
                         
                     }
             
                 
        // console.log( userDecryptedData);
        ...
        data: dataSource,
              columns: [
                        ...
                        {title: 'Email',
                          ...
                          default :-1,
                             className: "center",
                "defaultContent": "  <input type= 'button' value = 'Edit' class = 'editButton' > </input><input type= 'button' value = 'Delete' class = 'deleteButton' > </input>" 
...
deleteData(dataSelected[0],dataSelected[1],dataSelected[2],dataSelected[3],userKey)
...
var db = getDatabaseObject();
         db.clear('dataStorage').done(function() {
 ...
 if(results.length){
        ...
        for(numberOfItem = 0 ; numberOfItem < results.length ; numberOfItem++) {
               ...
               //  console.log( "obj"+object.userName);     
                  ...
                  userData  = decryptAllData(results[numberOfItem],userEncryptionKey,userArray);
                   ...
                   console.log( decryptedData(object.userName, userEncryptionKey) );  
                   
                    if(userData.userName !== decryptedData(object.userName, userEncryptionKey)){
  ...
  throw e;
    ...
    function deleteData( userName,userAddress,userNumber,userEmail,userKey) {
    
    var numberOfItems = null;
   
    var propertyNameArr = [ "userName","userAddress","userNumber","userEmail"];
    
    
    var userDataObject = getEncryptedUserObject(userName,userAddress,userNumber,userEmail,userKey);
...
db.keys('dataStorage').done(function(keys) {
      
    db.values('dataStorage').done(function(userData) {
              ...
              flag = validateUserData(userDataObject,userData[numberOfItems],userKey,propertyNameArr);
                   ...
                   //alert(flag);
                    ...
                    if(flag){
                        ...
                        console.log("name"+userData[numberOfItems].userName);
                        
                       remoteStorage.bic.removeData(userData[numberOfItems].userName);
                       
                       
                       db.remove('dataStorage',keys[numberOfItems]);
...
console.log(  userDataObject);
  ...
  console.log( results[userDataProperty[items]] +""+userDataProperty.length );
...
function getEncryptedUserObject(userName,userAddress,userNumber,userEmail,userKey){
...
//console.log(userDataArr)
 ...
 var userDataProperty =  [ "userName","userAddress","userNumber","userEmail"];
 ...
 console.log();
             ...
             console.log(flag);
                    ...
                    if(flag){
                        editRemoteStorage(results[items],editedData);  
...
function generateEditForm(userName,userAddress,userNumber,userEmail,userKey){
    ...
    var  editedData =  {};
    var userEncryptionKey = userKey;
    var popupTextBoxId =  [ "userName","userAddress","userNumber","userEmail"];
    
    
    var propertyArray =  [ "userName","userAddress","userNumber","userEmail"];
    
    var previousUserData = [ userName,userAddress,userNumber,userEmail];
   ...
   userPasswordLabel.innerHTML="User Address";
   ...
   userWebsiteLabel.innerHTML="User Number";
   ...
   userHintLabel.innerHTML="User Email";
   ...
   save.type = 'button';
    ...
    editUserPassword.id = 'userAddress';
    editUserWebsite.id = 'userNumber';
    editUserHint.id = 'userEmail';
   ...
   save.id="save";
    ...
    editUserPassword.value = userAddress;
    editUserWebsite.value  = userNumber;
    editUserHint.value = userEmail;
    ...
    //userRecord.push(generateCurrentDate());
        ...
        previousData = getEncryptedUserObject(userName,userAddress,userNumber,userEmail,userKey);
        
        editedData =  getEncryptedUserObject(editUserName.value,editUserPassword.value,editUserWebsite.value,editUserHint.value,userKey);
      ...
      //  console.log( previousData);
        ...
        getEditDData(previousData,editedData,userEncryptionKey,'dataStorage');
...
return userData;
 ...
 function editRemoteStorage(previoususerData,newuserData){
     
       console.log( newuserData.userName);
     
  console.log( previoususerData.userName);
     
      remoteStorage.bic.addUData(newuserData.userName,newuserData);
  remoteStorage.bic.removeData(previoususerData.userName);
