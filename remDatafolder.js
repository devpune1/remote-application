...
var schema = {
 ...
 stores: [{
    ...
    name: 'remstorage',    // required. object store name or TABLE name
...
console.log("value"+arr);
   ...
   db.put(db_name ,arr).done(function(x) {
...
function reloadTable(){
 ...
 db.executeSql('SELECT * FROM remstorage ').then (function(results) {
...
function decryptAllData(userData,userKey,userArray){
         ...
         for(var items = 0; items < userArray.length ; items++){
                     ...
                     if(decryptData(userData[userArray[items]],userKey) == ""){
                         ...
                         console.log( userDecryptedData[userArray[items]]);
                     }
